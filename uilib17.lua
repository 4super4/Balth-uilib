        ...
        local dropdown = {} do 
            ...
            do
                local instances = {} do 
                    ...
                    strokeMenu.ApplyStrokeMode = 'Border'
                    strokeMenu.Color = theme.Stroke
                    strokeMenu.LineJoinMode = 'Round'
                    strokeMenu.Name = '#stroke'
            ...
            dropdown.open = function(self)
                self.openState = true
                self.instances.menu.Size = UDim2.new(1, -6, 0, 100)  -- Example open size
                self:fireEvent('onOpen')
            end
            
            dropdown.close = function(self)
                self.openState = false
                self.instances.menu.Size = UDim2.new(1, -6, 0, 0)  -- Close the menu
            ...
            dropdown.addOption = function(self, option)
                ...
                optionButton.Name = option.value
                optionButton.Text = option.text
                optionButton.ZIndex = 35
                optionButton.BackgroundColor3 = theme.Button1
                optionButton.TextColor3 = Color3.new(1, 1, 1) -- Set text color to white
                optionButton.BorderColor3 = theme.Stroke -- Set stroke color to theme.Stroke
            
                optionButton.Size = UDim2.new(1, 0, 0, 20) -- Adjust size as needed
            ...
            dropdown.clearOptions = function(self)
                ...
                for i, child in ipairs(self.instances.menu:GetChildren()) do
                    if child:IsA('TextButton') then
                        print("Removing option:", child.Text)
                        child:Destroy()  -- Removes each option
                    end
                end
            end
